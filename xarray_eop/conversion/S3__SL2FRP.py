...
from xarray_eop.conversion.utils import str_to_number
...
out_path = Path("/mount/internal/work-st/projects/cs-412/2078-dpr/Samples/Auxiliary/Zarr_new/SL2_FRP")
tmp_path =  Path("/tmp")
...
def generate(adf_type: str)->None:
    ...
    if adf_type == "FRPAC":
        for legacy_adf in ["S3A_SL_2_FRPTAX",]:
    ...
    if adf_type == "FRPLC":
        ...
        old_zarr_path = Path("/mount/internal/work-st/projects/cs-412/2078-dpr/Samples/Auxiliary/Zarr/SL2_FRP")
    ...
    if adf_type == 'FRPPA':
        for legacy_adfs in [["S3A_SL_2_SXPAAX","S3A_SL_2_FXPAAX"],["S3B_SL_2_SXPAAX","S3B_SL_2_FXPAAX"]]:
